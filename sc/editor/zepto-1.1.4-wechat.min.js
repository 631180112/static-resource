// Zepto 1.1.4 (generated with Zepto Builder) - zepto event ajax touch - zeptojs.com/license 
var Zepto = function() {
    function t(t) {
    ...
    function l(t) {
        return t in L ? L[t] : L[t] = RegExp("(^|\\s)" + t + "(\\s|$)")
    }
    function f(t, e) {
    ...
    function p(t) {
        return "children" in t ? P.call(t.children) : E.map(t.childNodes,
        function(t) {
    ...
    function y(t, e) {
        var n = t.className || "",
        r = n && n.baseVal !== b;
        return e === b ? r ? n.baseVal: n: (r ? n.baseVal = e: t.className = e, b)
    }
    function x(t) {
        var e;
        try {
    ...
    Y.fragment = function(t, e, n) {
        var r, i, a;
        return R.test(t) && (r = E(M.createElement(RegExp.$1))),
        r || (t.replace && (t = t.replace(Z, "<$1></$2>")), e === b && (e = $.test(t) && RegExp.$1), e in U || (e = "*"), a = U[e], a.innerHTML = "" + t, r = E.each(P.call(a.childNodes),
        function() {
            a.removeChild(this)
        })),
        o(n) && (i = E(r), E.each(n,
    ...
    Y.init = function(t, n) {
        var r;
        if (!t) return Y.Z();
        if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && $.test(t)) r = Y.fragment(t, RegExp.$1, n),
        t = null;
        else {
            ...
            t = null;
            else if ($.test(t)) r = Y.fragment(t.trim(), RegExp.$1, n),
            t = null;
            else {
                if (n !== b) return E(n).find(t);
                r = Y.qsa(M, t)
    ...
    E.fn = {
        ...
        ready: function(t) {
            return X.test(M.readyState) && M.body ? t(E) : M.addEventListener("DOMContentLoaded",
            function() {
                t(E)
            },
            !1),
        ...
        filter: function(t) {
            return e(t) ? this.not(this.not(t)) : E(O.call(this,
            function(e) {
        ...
        parents: function(t) {
            ...
            function(t) {
                return (t = t.parentNode) && !r(t) && 0 > e.indexOf(t) ? (e.push(t), t) : b
            });
            return m(e, t)
        },
        parent: function(t) {
        ...
        attr: function(t, e) {
            ...
            return "string" != typeof t || 1 in arguments ? this.each(function(n) {
                if (1 === this.nodeType) if (i(t)) for (T in t) v(this, T, t[T]);
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || M.body; t && !_.test(t.nodeName) && "static" == E(t).css("position");) t = t.offsetParent;
                return t
            })
        }
    },
    ...
    q.forEach(function(e, n) {
        ...
        E.fn[e] = function() {
            ...
            return 1 > o.length ? this: this.each(function(t, e) {
                ...
                var s = E.contains(M.documentElement, i);
...
function(t) {
    ...
    function l(t) {
        ...
        t && (t == E ? "html": t == T ? "json": w.test(t) ? "script": b.test(t) && "xml") || "text"
    }
    function f(t, e) {
    ...
    t.ajax = function(e) {
        ...
        if (i && i.promise(b), n.crossDomain || x("X-Requested-With", "XMLHttpRequest"), x("Accept", v || "*/*"), (v = n.mimeType || v) && (v.indexOf(",") > -1 && (v = v.split(",", 2)[0]), b.overrideMimeType && b.overrideMimeType(v)), (n.contentType || n.contentType !== !1 && n.data && "GET" != n.type.toUpperCase()) && x("Content-Type", n.contentType || "application/x-www-form-urlencoded"), n.headers) for (g in n.headers) x(g, n.headers[g]);
        if (b.setRequestHeader = x, b.onreadystatechange = function() {
            if (4 == b.readyState) {
                ...
                if (b.status >= 200 && 300 > b.status || 304 == b.status || 0 == b.status && "file:" == w) {
                    ...
                    r ? s(r, "parsererror", b, n, i) : a(e, b, n, i)
                } else s(b.statusText || null, b.status ? "error": "abort", b, n, i)
            }
        },
...
function(t) {
    ...
    t.fn.on = function(e, n, r, i, o) {
        ...
        function(t, e) {
            h.on(t, n, r, e, o)
        }), h) : (m(n) || d(i) || i === !1 || (i = r, r = n, n = f), (d(r) || r === !1) && (i = r, r = f), i === !1 && (i = T), h.each(function(h, d) {
            o && (a = function(t) {
                return u(d, t.type, i),
